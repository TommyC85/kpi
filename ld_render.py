...
.topnav .brand{font-weight:750;font-size:13.5px}.topnav .links{display:flex;gap:4px;flex-wrap:wrap}
.topnav a{font-size:13px;font-weight:600;color:var(--ink-2);text-decoration:none;padding:6px 12px;border-radius:8px}
.topnav a:hover{background:var(--panel-2);color:var(--ink)}.topnav a.active{background:var(--accent-soft);color:var(--accent)}
...
NAV = ('<nav class="topnav"><span class="brand">📊 Media Buying</span><div class="links">'
       '<a href="/tommaso/">Riepilogo</a><a href="/tommaso/varini/">Varini</a>'
       '<a href="/tommaso/kpi/learndash/" class="active">Varini · Corsi</a>'
       '<a href="/tommaso/kpi/">KPI clienti</a><a href="/tommaso/kpi/pontoni/">Pontoni · moduli</a></div></nav>')
